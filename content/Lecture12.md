...
var firebaseConfig = {
      ...
      firebase.initializeApp(firebaseConfig);
       ...
       const commentsRef = rootRef.child('comments/spl2');
       ...
       var showat = document.getElementById('spl2');
       //Get comments whose from page equals this page's pathname.
       var commentsRef = firebase.database().ref('comments/spl2');
...
function removeData_1(params){
   ...
   // key = document.getElementById('key').value;
    fb.child('comments/spl2'+ params.id +'/').remove()
