...
#Slides<br>
#<li><a href="https://www.dropbox.com/s/x3uexzbr8gvq8qv/Back_Propagation.pptx?dl=0" target="_blank">Back Propagation</a></li> <br>
...
var firebaseConfig = {
      ...
      firebase.initializeApp(firebaseConfig);
       ...
       const commentsRef = rootRef.child('comments/lecture10');
       ...
       var showat = document.getElementById('lecture10');
       //Get comments whose from page equals this page's pathname.
       var commentsRef = firebase.database().ref('comments/lecture10');
...
function removeData_1(params){
   ...
   // key = document.getElementById('key').value;
    fb.child('comments/lecture10'+ params.id +'/').remove()
