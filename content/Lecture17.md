...
var firebaseConfig = {
      ...
      firebase.initializeApp(firebaseConfig);
       ...
       const commentsRef = rootRef.child('comments/spl3');
       ...
       var showat = document.getElementById('spl3');
       //Get comments whose from page equals this page's pathname.
       var commentsRef = firebase.database().ref('comments/spl3');
...
function removeData_1(params){
   ...
   // key = document.getElementById('key').value;
    fb.child('comments/spl3'+ params.id +'/').remove()
