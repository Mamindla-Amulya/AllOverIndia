...
var firebaseConfig = {
      ...
      firebase.initializeApp(firebaseConfig);
       ...
       const commentsRef = rootRef.child('comments/lecture23');
       ...
       var showat = document.getElementById('lecture23');
       //Get comments whose from page equals this page's pathname.
       var commentsRef = firebase.database().ref('comments/lecture23');
...
function removeData_1(params){
   ...
   // key = document.getElementById('key').value;
    fb.child('comments/lecture23'+ params.id +'/').remove()
