...
#Introduction <br><br>
<iframe src="https://cdn.talentsprint.com/talentsprint/archives/sc/aiml/aiml_allover_india/11_prediction_from_context.mp4"width="640" height="480"></iframe>
<br><br>
...
var firebaseConfig = {
      ...
      firebase.initializeApp(firebaseConfig);
       ...
       const commentsRef = rootRef.child('comments/lecture20');
       ...
       var showat = document.getElementById('lecture20');
       //Get comments whose from page equals this page's pathname.
       var commentsRef = firebase.database().ref('comments/lecture20');
...
function removeData_1(params){
   ...
   // key = document.getElementById('key').value;
    fb.child('comments/lecture20'+ params.id +'/').remove()
